...
[Continue to Part 4: Metalogic and Conclusion →](06-metalogic.qmd)



:::{.card .mb-4}
<div class="card-header bg-primary text-white">
**Problem: Expressive Power**
</div>
<div class="card-body">
Attempt to translate a complex natural language concept into the formal syntax you designed in Chapter 2. Where does your system succeed, and where does it break down?

<textarea id="05-translation-prob" class="form-control problem-input" rows="8" placeholder="Enter your response here..."></textarea>
