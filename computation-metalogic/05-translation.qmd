...
<syntax-sandbox title="Interactive Sandbox: Negation Normalization" description="Practice pushing in or pulling out negation signs to normalize formulas." data-groups='[
...
<syntax-sandbox title="Interactive Sandbox: Numerical Translation" description="Experiment with translating numerical concepts ('At least n', 'At most n') into logic." data-groups='[
  { "label": "Variables", "buttons": ["x", "y", "z", "a", "b", "c"] },
  { "label": "Predicates", "buttons": [{"val": "F", "spaceAfter": false}, {"val": "G", "spaceAfter": false}, {"val": "=", "spaceAfter": false, "spaceBefore": false}] },
  { "label": "Connectives", "buttons": [{"val": "¬", "spaceAfter": false}, "∧", "∨", "→", "↔"] },
  { "label": "Quantifiers", "buttons": [{"val": "∀", "spaceAfter": false}, {"val": "∃", "spaceAfter": false}] },
  { "label": "Syntax", "buttons": [{"val": "(", "spaceAfter": false}, {"val": ")", "spaceBefore": false}, {"val": ",", "spaceBefore": false}] }
]'></syntax-sandbox>
...
<syntax-sandbox problem-id="05-translation-prob1" title="Problem 1: Expressive Power" description="Attempt to translate a complex natural language concept into the formal syntax you designed in Chapter 2. Where does your system succeed, and where does it break down?" data-groups='[
  { "label": "Variables", "buttons": ["x", "y", "z", "a", "b", "c"] },
  { "label": "Predicates", "buttons": [{"val": "F", "spaceAfter": false}, {"val": "G", "spaceAfter": false}, {"val": "R", "spaceAfter": false}] },
  { "label": "Connectives", "buttons": [{"val": "¬", "spaceAfter": false}, "∧", "∨", "→", "↔"] },
  { "label": "Quantifiers", "buttons": [{"val": "∀", "spaceAfter": false}, {"val": "∃", "spaceAfter": false}] },
