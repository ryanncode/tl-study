...
<syntax-sandbox problem-id="03-deduction-prob1" title="Problem 1: Rules of Inference" description="Define the axioms and inference rules (e.g., Modus Ponens equivalent) that allow your system to 'compute' proofs. How does one statement legally transition into the next?" data-groups='[]'></syntax-sandbox>

<syntax-sandbox problem-id="03-deduction-prob2" title="Problem 2: Proof Strategy" description="If your goal in a Fitch proof is to derive P → (Q ∨ R), what should your immediate first step be according to Velleman's goal-directed strategies?" data-groups='[]'></syntax-sandbox>
