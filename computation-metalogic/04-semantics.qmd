...
**Problem: Model Theory**
</div>
<div class="card-body">
Construct a mathematical model or "world" where your syntax maps to actual truth-values. What objects exist in your domain, and how do predicates assign meaning to them?

<textarea id="04-semantics-prob" class="form-control problem-input" rows="8" placeholder="Enter your response here..."></textarea>
