...
<syntax-sandbox problem-id="04-semantics-prob1" title="Problem 1: Model Theory" description="Construct a mathematical model or 'world' where your syntax maps to actual truth-values. What objects exist in your domain, and how do predicates assign meaning to them?" data-groups='[]'></syntax-sandbox>

<syntax-sandbox problem-id="04-semantics-prob2" title="Problem 2: Soundness and Completeness" description="In your own words, define Soundness and Completeness in logic. Why are these properties crucial for a formal system?" data-groups='[]'></syntax-sandbox>
