...
<div class="card-body">
Define the philosophical boundaries and intended use-case of the formal system you are about to design. What domain of "truth" or "computation" is your toy system attempting to model? (e.g. A logic for a vending machine, a logic for moral obligation, a logic for quantum states).

<textarea id="01-conceptual-foundations-prob" class="form-control problem-input" rows="8" placeholder="Enter your response here..."></textarea>
