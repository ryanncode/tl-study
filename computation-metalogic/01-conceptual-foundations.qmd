...
<syntax-sandbox data-groups='[
  ...
  [{"val": "(", "spaceAfter": false}, {"val": ")", "spaceBefore": false}]
]'></syntax-sandbox>
...
<syntax-sandbox problem-id="01-conceptual-foundations-prob1" title="Problem 1: Domain Definition" description="Define the philosophical boundaries and intended use-case of the formal system you are about to design. What domain of 'truth' or 'computation' is your toy system attempting to model? (e.g. A logic for a vending machine, a logic for moral obligation, a logic for quantum states)." data-groups='[]'></syntax-sandbox>

<syntax-sandbox problem-id="01-conceptual-foundations-prob2" title="Problem 2: Use and Mention" description="Explain the Use/Mention distinction. Why is it important when we formalize logic computationally?" data-groups='[]'></syntax-sandbox>
