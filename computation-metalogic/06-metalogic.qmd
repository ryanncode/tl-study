...
<syntax-sandbox problem-id="06-metalogic-prob1" title="Problem 1: Soundness & Completeness" description="Analyze your toy system. Do you believe it is Sound (it only proves true things) and Complete (it can prove all true things within its domain)? Defend your architectural choices." data-groups='[]'></syntax-sandbox>

<syntax-sandbox problem-id="06-metalogic-prob2" title="Problem 2: The Limits of Logic" description="Explain Compactness and the Löwenheim-Skolem theorems. How do these theorems limit the expressive power of First-Order Logic?" data-groups='[]'></syntax-sandbox>
