...
* **[TAPL] Types and Programming Languages**
    ...
    * **Key Concepts:**
        * **Inductive Definitions:** The definitive treatment of defining terms inductively, proving why `data WFF = ...` is a rigorous mathematical definition (Pierce, pp. 23–44).
        * **Safety = Progress + Preservation:** The modern computational parallel to logical "Soundness" (Pierce, pp. 95–98).
