...
<syntax-sandbox title="Interactive Sandbox: WFF Construction" description="Practice building Well-Formed Formulas using the recursive rules of syntax." data-groups='[
  { "label": "Data Types", "buttons": ["WFF", "Predicate", "Term", "Variable", "Name"] },
  { "label": "Base Constructors", "buttons": ["Atomic", "Constant"] },
  { "label": "Recursive Constructors", "buttons": ["Not", "And", "Or", "Implies", "ForAll", "Exists"] },
...
<syntax-sandbox problem-id="02-syntax-prob1" title="Problem 1: Grammatical Architecture" description="Write the recursive formation rules and formal alphabet for your system. What symbols are allowed? How do you form a 'well-formed formula' (wff) in your universe?" data-groups='[
  { "label": "Data Types", "buttons": ["WFF", "Predicate", "Term", "Variable", "Name"] },
  { "label": "Base Constructors", "buttons": ["Atomic", "Constant"] },
  { "label": "Recursive Constructors", "buttons": ["Not", "And", "Or", "Implies", "ForAll", "Exists"] },
  { "label": "Syntax", "buttons": ["[", "]", "=", "|"] }
