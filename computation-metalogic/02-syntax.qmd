...
<syntax-sandbox data-groups='[
  ["x", "y", "z", "a", "b", "c"], 
  [
    {"val": "F", "spaceAfter": false}, 
    {"val": "G", "spaceAfter": false}, 
    {"val": "R", "spaceAfter": false}
  ], 
  [
...
**Problem: Grammatical Architecture**
</div>
<div class="card-body">
Write the recursive formation rules and formal alphabet for your system. What symbols are allowed? How do you form a "well-formed formula" (wff) in your universe?

<textarea id="02-syntax-prob" class="form-control problem-input" rows="8" placeholder="Enter your response here..."></textarea>
